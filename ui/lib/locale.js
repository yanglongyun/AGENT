...
const dictionaries = {
  en: {
    ...
    page_desc_subscriptions: 'Messages generated by background subscriptions are listed here so you can track automatic follow-up work.',
    ...
    page_desc_spaces: 'Spaces map local project folders so chats can be organized by project and directory.',
    page_desc_growth: 'Growth records durable behavior updates learned by the agent over time.',
    page_desc_apps: 'Apps are focused workspaces built into the agent for specific tasks.',
    spaces_name: 'Name',
    spaces_add: 'Add',
    spaces_empty: 'No spaces yet',
    spaces_back: 'Back',
    spaces_new_chat_here: 'New chat here',
    spaces_folders: 'Folders',
    spaces_no_folders: 'No folders',
    spaces_no_chats: 'No chats in this folder',
    spaces_messages_count: '{n} messages',
    spaces_create_failed: 'Create space failed',
    spaces_create_chat_failed: 'Create chat failed',
  },
  zh: {
    nav_new_chat: '新聊天',
    ...
    page_desc_subscriptions: '这里显示后台订阅产生的消息，方便查看自动跟进工作的状态。',
    ...
    page_desc_spaces: '空间映射本地项目目录，用来按项目和目录组织对话。',
    page_desc_growth: '成长记录 Agent 在运行过程中沉淀下来的长期行为更新。',
    page_desc_apps: '应用是 Agent 内置的专用工作区，用于处理特定类型的任务。',
    spaces_name: '名称',
    spaces_add: '添加',
    spaces_empty: '暂无空间',
    spaces_back: '返回',
    spaces_new_chat_here: '在此新建对话',
    spaces_folders: '目录',
    spaces_no_folders: '暂无目录',
    spaces_no_chats: '此目录暂无对话',
    spaces_messages_count: '{n} 条消息',
    spaces_create_failed: '创建空间失败',
    spaces_create_chat_failed: '创建对话失败',
  },
};
