...
<template>
  <div class="m tool">
    ...
    <div class="overflow-hidden rounded-xl border border-[var(--line2)] bg-white">
      ...
      <div v-if="msg.expanded" class="txt ai-text p-3" v-html="renderMd(displayContent)"></div>
    </div>
  </div>
</template>
...
:deep(pre) { max-width: 100%; overflow-x: auto; white-space: pre; border-radius: 10px; padding: 10px; margin: 8px 0; background: #fff; border: 1px solid var(--line2); font-size: 12px; }
